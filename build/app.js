...
const tasks_router_1 = require("./resources/tasks/tasks.router");
exports.server = (0, fastify_1.default)({ logger: true });
exports.server.register(users_router_1.usersRoutes);
exports.server.register(boards_router_1.boardsRoutes);
exports.server.register(tasks_router_1.tasksRoutes);
